    ...
    <main className="pt-16 min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-4">
          ...
          <button
            onClick={() => { login(); router.push("/design"); }}
            className="mt-4 w-full border border-gray-200 py-3 rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
          >
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          No account?{" "}
          <Link href="/register" className="text-black font-medium hover:underline">Sign up free</Link>
        </p>
      </div>
    </main>
  );
